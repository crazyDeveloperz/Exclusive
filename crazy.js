...
async function handleRequest(request) {
  ...
  return new Response(generateRedirectPage(linkParam), {
    headers: { 'Content-Type': 'text/html' }
  })
}

function generateRedirectPage(linkParam) {
...
<head>
  ...
  <title>ThammuTV - Premium Access</title>
  <style>
    * {
      margin: 0;
      padding: 0;
      ...
      <div class="plans-container">
        <div class="plan-card free">
          ...
          <div class="plan-features">
            ...
            <a href="#" class="plan-button">Continue with Free</a>
          </div>
        </div>
...
<body>
  <div class="error-card">
    ...
    <p>Join our official channel for updates:</p>
    <a href="${CHANNEL_LINK}" class="btn">Join Telegram Channel</a>
  </div>
</body>
</html>`;
}
